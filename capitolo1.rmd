...
L'obiettivo di questa presentazione è quello di introdurre i vari elementi di una meta-analisi (la dimensione dell'effetto per ogni studio, il peso assegnato a ogni dimensione dell'effetto, la stima dell'effetto di sintesi e così via) e di mostrare dove ciascuno di essi si inserisce nello schema più ampio. Nei capitoli successivi, ognuno di questi elementi verrà esplorato in dettaglio.
